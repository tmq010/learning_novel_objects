function [IsQuit, performance] = learn_fixation(subjID, whichStimuli, whichFamily, sequentCode, learnRepeat,itemDurDefine,blankDur)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% command:
...
try
    ...
    blankPtr =  Screen('OpenOffscreenWindow',window,  [186 186 186], pixRect);
    ...
    Screen('DrawText',window,'This block is fixation task only. It should be easy. Press T whenever there is color change.',(screenRect(3)/2-700),screenRect(4)/2-80);
    Screen('DrawText',window, ['Now we start. Press space key when you are ready.'],(screenRect(3)/2-400),screenRect(4)/2-34);
    ...
    for theBlock = 1:numBlocks
        ...
        for i = 1:itemsPerBlock*2
            ...
            Screen('DrawTexture', window, blankPtr, [], CenterRect(pixRect, screenRect));
            ...
            if blankDur > 0
                Screen('DrawTexture', window, maskPtr, [], CenterRect(pixRect, screenRect));
